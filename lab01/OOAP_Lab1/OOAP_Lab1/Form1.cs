    ...
    public partial class PCBuilder : Form
    {
        ...
        private void ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string message = "Программа: PCBuilder\n\n" +
                ...
                "• Процессор (CPU) - обязтальный\n" +
                "• Материнская плата (Motherboard) - обязтальный\n" +
                "• Оперативная память (RAM) - обязтальный\n" +
                "• Видеокарта (GPU) - необязтальный\n" +
                "• Жёсткий диск (HDD) - необязтальный\n" +
                "• Твердотельный накопитель (SSD) - необязтальный\n" +
                "(важно понимать, что обязательно должен быть HDD или SSD)\n" +
                "• Блок питания (PSU) - обязтальный\n\n" +
                "Как пользоваться:\n" +
                "1. Выберите компоненты из каталога\n" +
                "2. Добавляйте их в сборку\n" +
                "3. Программа проверит совместимость\n";
